...
<div class="mainindex">
    ...
    <ul class="iconlist">
        ...
        <li><img src="<?= ADMIN_IMG_PATH ?>ico02.png"/>
            <p><a href="#">发布文章</a></p></li>
        <li><img src="<?= ADMIN_IMG_PATH ?>ico03.png"/>
            <p><a href="#">数据统计</a></p></li>
        <li><img src="<?= ADMIN_IMG_PATH ?>ico04.png"/>
            <p><a href="#">文件上传</a></p></li>
        <li><img src="<?= ADMIN_IMG_PATH ?>ico05.png"/>
            <p><a href="#">目录管理</a></p></li>
        <li><img src="<?= ADMIN_IMG_PATH ?>ico06.png"/>
            <p><a href="#">查询</a></p></li>
    ...
    <div class="welinfo">
        <span><img src="<?= ADMIN_IMG_PATH ?>dp.png" alt="提醒"/></span>
        <b>信息管理系统使用指南</b>
    </div>
