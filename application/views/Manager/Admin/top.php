...
<ul class="nav">
    <li><a href="default.html" target="rightFrame" class="selected"><img src="<?=ADMIN_IMG_PATH?>icon01.png" title="工作台"/>
            <h2>工作台</h2></a></li>
    ...
    <li><a href="computer.html" target="rightFrame"><img src="<?=ADMIN_IMG_PATH?>icon05.png" title="文件管理"/>
            <h2>文件管理</h2></a></li>
    <li><a href="tab.html" target="rightFrame"><img src="<?=ADMIN_IMG_PATH?>icon06.png" title="系统设置"/>
            <h2>系统设置</h2></a></li>
</ul>
...
<div class="topright">
    <ul>
        ...
        <li><a href="#">关于</a></li>-->
        <li><a href="<?=ADMIN_MANAGER_PATH?>/logout" target="_parent">退出</a></li>
    </ul>
